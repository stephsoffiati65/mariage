;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Aug 05, 2024 15:00:00").getTime();
		...
		// Display the result in an element with id="demo"
		document.getElementById("jours").innerHTML = days +" <small>days</small>";
		document.getElementById("heures").innerHTML = hours + " <small>hours</small> ";
		document.getElementById("minutes").innerHTML = minutes + " <small>minutes</small> ";
		document.getElementById("secondes").innerHTML = seconds + " <small>seconds</small> ";
